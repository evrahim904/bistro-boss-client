          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
              ...
              <div className="form-control">
                ...
                {errors.password?.type === 'pattern' && <p className="text-red-600"> password must be one uppercase one lower and one unique character</p>}
                <label className="label">
            ...
            <Link to="/login"><p>already have an account? please <u>login</u></p></Link>
